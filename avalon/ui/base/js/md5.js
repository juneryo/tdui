(function(global, factory) {
	if (typeof module === "object" && typeof module.exports === "object") {
		module.exports = global.document ? factory(global, true) : function(w) {
			if (!w.document) {
				throw new Error('MD5 requires a window with a document');
			}
			return factory(w);
		};
	}else {
	...
	var MD5 = {
		encrypt: function(string) {
			...
			string = this.md5_Utf8Encode(string);
			x = this.md5_ConvertToWordArray(string);
			a = 0x67452301;
			b = 0xEFCDAB89;
			c = 0x98BADCFE;
			d = 0x10325476;
		...
		md5_ConvertToWordArray: function(string) {
			var lWordCount;
		...
		md5_Utf8Encode: function(string) {
